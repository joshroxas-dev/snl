...
<div class="page-wrapper" ng-app="appCon" ng-controller="purchaseorderController" ng-cloak>
                                ...
                                <div class="col-sm-6 p-l-0">
                                    <div class="form-group">
                                        ...
                                        <select class="" id="creditcard" ng-model="main.creditcard">
                                            <option ng-repeat="row in creditcard" value="{{row.creditcardid}}">{{row.creditcard}}</option>
                                        </select>
                                        <small ng-show="validate && (main.creditcard == '')" class="req-txt">Courier is required</small>
                                    </div>
                                </div>
                                <div class="col-sm-6 p-r-0">
                                    <div class="form-group">
                    ...
                    <div class="card">
                        <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr ng-repeat="podata in postock">
                                            ...
                                            <td>
                                                <div class="popover__wrapper wrap_cus">
                                                    ...
                                                    <div  class="d-inline-block"  style="width: 35px; margin: auto;" ng-hide="!podata.stocksid">
                                                        <a href="#" ng-mouseover="getinfop(podata.stocksid, podata.stockguid, podata.rate);" class="mrcs-5 popover__title">
                                                        ...
                                                        <div class="col-sm-12 potabletd"> 
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{prodintf.unitpricephp | number:2}}</td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                            ...
                                            <td>
                                                <div  class="d-inline-block" data-toggle="tooltip" data-placement="top" title="Delete Product" style="width: 35px; margin: auto;">
                                                    <a href class="mrcs-5" ng-click="delStockRow(podata.id)">
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td class="addrow"><i class="zmdi zmdi-plus txt-bold m-r-5"></i><a ng-click="newStockRow();">Add Row</a></td>
                                        </tr>
                            ...
                            <div align="right" class="m-t-30">
                                ...
                                <a href="" ng-click="save('placed');" class="btn btn-success" ng-show="!placedorder" >Place Order</span></a>
                                
                                <a href="" ng-click="save('draft');" class="btn btn-primary m-l-10" ng-show="!placedorder"><span>Save as Draft</span></a>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/angular-ui-bootstrap/0.10.0/ui-bootstrap-tpls.min.js"></script>
    ...
    <script src="app-controller/js-controller/purchaseorder1Ctrl.js"></script>
