...
gulp.task('copyAddonCss', () => {
    ...
    var style2 = gulp.src(['./node_modules/morris.js/morris.css']).pipe(gulp.dest('./assets/vendors/morris.js'));
    ...
    var style13 = gulp.src(['./node_modules/jquery-steps/demo/css/jquery.steps.css']).pipe(gulp.dest('./assets/vendors/jquery-steps'));
    ...
    var style16 = gulp.src(['./node_modules/datatables.net-bs4/css/dataTables.bootstrap4.css']).pipe(gulp.dest('./assets/vendors/datatables.net-bs4'));
