...
$pdf->SetFont('Arial','',9);
$pdf->Cell(190, 2, 'PROFIT AND LOSS % OF TOTAL INCOME', 0, 1, 'C');
...
$pdf->MultiCell($cell_width2,$cell_height,'1 JAN - 18 OCT, 2019',0 ,1); 
$current_x+=$cell_width2;                           
$pdf->SetXY($current_x, $current_y);   

$pdf->MultiCell($cell_width3,$cell_height,'% OF INCOME',0 ,1);
$current_x+=$cell_width3;
$pdf->WriteHTML('<hr>');
...
$pdf->MultiCell($cell_width,$cell_height,'Income',0 ,1); 
$current_x+=$cell_width;                           
$pdf->SetXY($current_x, $current_y);     
...
$pdf->MultiCell($cell_width3,$cell_height,'166,066.00',0 ,1);
$current_x+=$cell_width3;
...
$pdf->MultiCell($cell_width,$cell_height,'Total Income',0 ,1); 
$current_x+=$cell_width;                           
$pdf->SetXY($current_x, $current_y);     

$pdf->MultiCell($cell_width2,$cell_height,'PHP1,820,714.26',0 ,1); 
$current_x+=$cell_width2;                           
$pdf->SetXY($current_x, $current_y);  

$pdf->MultiCell($cell_width3,$cell_height,'100.00%',0 ,1);
$current_x+=$cell_width3;
