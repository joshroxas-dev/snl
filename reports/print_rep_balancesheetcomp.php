...
$pdf->SetFont('Arial','',9);
$pdf->Cell(190, 2, 'BALANCE SHEET COMPARISON', 0, 1, 'C');
...
$pdf->MultiCell($cell_width2,$cell_height,'AS OF OCT 18, 2019',0 ,1); 
$current_x+=$cell_width2;                           
$pdf->SetXY($current_x, $current_y);   

$pdf->MultiCell($cell_width3,$cell_height,'AS OF OCT 18, 2018 (PY)',0 ,1);
