...
$pdf->MultiCell($cell_width4,$cell_height,'DUE DATE',0 ,1); 
$current_x+=$cell_width4;                           
$pdf->SetXY($current_x, $current_y);               

$pdf->MultiCell($cell_width5,$cell_height,'PAST DUE',0 ,1); 
$current_x+=$cell_width5;                           
$pdf->SetXY($current_x, $current_y); 

$pdf->MultiCell($cell_width6,$cell_height,'AMOUNT',0 ,1); 
...
$pdf->MultiCell($cell_width4,$cell_height,'07/09/2019',0 ,1); 
$current_x+=$cell_width4;                           
$pdf->SetXY($current_x, $current_y);               

$pdf->MultiCell($cell_width5,$cell_height,'101',0 ,1); 
$current_x+=$cell_width5;                           
$pdf->SetXY($current_x, $current_y); 
