...
<div class="page-wrapper" ng-app="appCon" ng-controller="customerorderController" ng-cloak>
    ...
    <div class="page-content" ng-show="view=='main'">
         <h3 class="d-inline-block">Balance Sheet</h3>
         <a href="rprint_rep_balsheet.php" class="btn btn-primary" style="margin-left: 13px; margin-bottom: 15px;" target="_blank">PRINT</a>
