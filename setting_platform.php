...
?>
<div class="page-wrapper" ng-app="appCon" ng-controller="manageplatformController">
    <?php include 'includes/top-bar.php' ?>

    <!-- TABLE LIST-->
    <div class="page-content" style="margin-top: 60px">
        <h3 class="d-inline-block">Platform</h3>
        <div class="row">
            <div class="col-sm-5 grid-margin stretch-card">
                <div class="card">
                <form method="POST" ng-submit="addplatformForm(data)">
                    <div class="card-body">
                        <h4 class="card-title">{{title}}</h4>
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <input class="form-control" name="" ng-model="data.platformid" type="hidden">
                                    <tr>
                                        <td><label for="">Platform Name: </label></td>
                                        <td><input id="" class="form-control" name="" ng-model="data.platform" type="text" required>
                            ...
                            <input class="btn btn-success" type="submit" name="addPlatform" value="Save">
                            </div>
                        </div>
                    </div>
                </form>
                    ...
                    <div class="card-body" ng-cloak>
                        ...
                        <div class="row">
                            <div class="col-md-12" ng-show="filter_data > 0">
                                <table class="table">
                                    <thead>
                                        <th>ID &nbsp;<a ng-click="sort_with('platform');"><i class="glyphicon glyphicon-sort"></i></a></th>
                                        <th>Platform &nbsp;<a ng-click=""><i class="glyphicon glyphicon-sort"></i></a></th>
                                        <th>Action</th>
                                    </thead>
                                    <tbody>
                                        <tr ng-repeat="data in searched = (file | filter:search | orderBy : base :reverse) | beginning_data:(current_grid-1)*(data_limit == 'ALL' ? entire_user : data_limit) | limitTo:(data_limit == 'ALL' ? entire_user : data_limit)"> 
                                            ...
                                            <td>{{data.platform}}</td>
                                            <td>
                                                <div class="d-inline-block" data-toggle="tooltip" data-placement="top" title="Edit Platform" style="width: 35px; margin: auto;">
                                                    <a href ng-click="platformpage(type='edit', id=data.platformid)" class="btn mrcs-5 action__btn">
                                                ...
                                                <div class="d-inline-block" data-toggle="tooltip" data-placement="top" title="Delete Platform" style="width: 35px; margin: auto;">
                                                    <a href ng-click="deleteplatform(data.platformid)" class="btn mrcs-5 action__btn">
    ...
    <script src="app-controller/js-controller/platformCtrl.js"></script>
